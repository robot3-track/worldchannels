...
function resolveChannelLocation(channelName: string, m3uCountry: string): LocationResult {
  ...
  const regionalCities = [
    ...
    // International major hubs - Ordered to prevent misclassification (India/ME before Japan)
    ...
    // East Asia (Strict keywords for Japan to avoid Indian/ME news overlap)
