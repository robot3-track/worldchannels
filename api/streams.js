...
const regionalCities = [
    ...
    { keys: ["toronto", "canada", "cbc", "ctv", "vancouver", "global news canada", "tsn", "sportsnet"], lat: 43.6532, lon: -79.3832, country: "CA" },
    { keys: ["mexico", "televisa", "tv azteca", "canal 5", "las estrellas", "tudn"], lat: 19.4326, lon: -99.1332, country: "MX" },
    { keys: ["brazil", "brasil", "rio", "sao paulo", "record news", "globo", "sbt", "bandeirantes", "sportv"], lat: -15.7938, lon: -47.8828, country: "BR" },
    { keys: ["argentina", "buenos aires", "tyc sports", "telefe", "eltrece", "tv publica", "canal 9", "america tv"], lat: -34.6037, lon: -58.3816, country: "AR" },
    { keys: ["chile", "santiago", "tvn", "mega", "canal 13", "chilevision", "cdf"], lat: -33.4489, lon: -70.6693, country: "CL" },
    { keys: ["colombia", "bogota", "caracol", "rcn", "canal 1", "win sports", "senel colombia"], lat: 4.7110, lon: -74.0721, country: "CO" },
    { keys: ["peru", "lima", "america tv peru", "latina", "panamericana", "atv", "golperu"], lat: -12.0464, lon: -77.0428, country: "PE" },
    { keys: ["venezuela", "caracas", "venevision", "televen", "vtv", "meridiano"], lat: 10.4806, lon: -66.9036, country: "VE" },
    { keys: ["uruguay", "dsports uruguay", "dsports", "teledoce", "canal 10 uruguay"], lat: -33.0000, lon: -56.0000, country: "UY" },
    { keys: ["ecuador", "quito", "ecuavisa", "teleamazonas", "tc television"], lat: -0.1807, lon: -78.4678, country: "EC" },
    ...
    // --- EUROPE ---
    { keys: ["bbc", "sky news", "london", "uk", "british", "itv", "channel 4", "channel 5", "tnt sports"], lat: 51.5074, lon: -0.1278, country: "UK" },
    { keys: ["france", "paris", "bfmtv", "france 24", "arte french", "gulli", "europe", "euronews", "bfm2", "bfm", "bfm lyon", "tf1", "canal+"], lat: 48.8566, lon: 2.3522, country: "FR" },
    { keys: ["germany", "deutsche", "berlin", "ard", "zdf", "rtl", "dw", "more than sports", "prosieben", "sat.1"], lat: 52.5200, lon: 13.4050, country: "DE" },
    { keys: ["rome", "italy", "rai", "mediaset", "la7", "milan", "milano", "naples", "napoli", "venice", "venezia", "sky tg24"], lat: 41.9028, lon: 12.4964, country: "IT" },
    { keys: ["madrid", "spain", "rtve", "antena", "arena sport 1 premium bh (1080p)", "la 1", "telecinco", "la sexta", "movistar"], lat: 40.4168, lon: -3.7038, country: "ES" },
    { keys: ["moscow", "russia", "rt doc", "rt news", "rt eng", "eurasia", "euroasia", "1+1 marafon", "channel one russia", "ntv russia", "match tv"], lat: 55.7558, lon: 37.6173, country: "RU" },
    { keys: ["ireland", "dublin", "rte", "rte one", "rte two", "virgin media ireland", "tg4"], lat: 53.3498, lon: -6.2603, country: "IE" },
    { keys: ["portugal", "lisbon", "rtp", "sic", "tvi", "sport tv portugal"], lat: 38.7223, lon: -9.1393, country: "PT" },
    { keys: ["greece", "athens", "ert", "mega channel greece", "skai", "alpha tv", "antenna greece", "novasports"], lat: 37.9838, lon: 23.7275, country: "GR" },
    { keys: ["poland", "warsaw", "tvp", "polsat", "tvn poland", "canal+ polska", "eleven sports poland"], lat: 52.2297, lon: 21.0122, country: "PL" },
    { keys: ["romania", "bucharest", "protv", "antena 1 romania", "digi24", "tvr", "digi sport"], lat: 44.4268, lon: 26.1025, country: "RO" },
    { keys: ["serbia", "arena sport 1 premium", "arena sport 2 premium", "arena sport 3 premium", "arena sport 4 premium", "rts serbia", "prva"], lat: 44.8176, lon: 20.4569, country: "RS" },
    { keys: ["sweden", "stockholm", "svt", "tv4 sweden", "viaplay"], lat: 59.3293, lon: 18.0686, country: "SE" },
    { keys: ["norway", "oslo", "nrk", "tv2 norway", "vg tv"], lat: 59.9139, lon: 10.7522, country: "NO" },
    { keys: ["denmark", "copenhagen", "dr1", "dr2", "tv2 denmark"], lat: 55.6761, lon: 12.5683, country: "DK" },
    { keys: ["finland", "helsinki", "yle", "mtv3", "nelonen"], lat: 60.1695, lon: 24.9354, country: "FI" },
    { keys: ["netherlands", "amsterdam", "dutch", "npo", "rtl nederland", "sbs6", "ziggo sport", "espn nl"], lat: 52.3676, lon: 4.9041, country: "NL" },
    { keys: ["belgium", "brussels", "vrt", "rtbf", "vtm"], lat: 50.8503, lon: 4.3517, country: "BE" },
    { keys: ["switzerland", "zurich", "geneva", "srf", "rts", "rsi", "blue sport"], lat: 46.8182, lon: 8.2275, country: "CH" },
    { keys: ["austria", "vienna", "orf", "servustv", "atv austria"], lat: 48.2082, lon: 16.3738, country: "AT" },
    { keys: ["ukraine", "kyiv", "1+1", "inter", "ictv", "stb", "novy channel", "suspilne"], lat: 50.4501, lon: 30.5234, country: "UA" },
    { keys: ["czech republic", "prague", "ct1", "nova cz", "prima tv"], lat: 50.0755, lon: 14.4378, country: "CZ" },
    { keys: ["hungary", "budapest", "mtva", "rtl klub", "tv2 hungary", "spiler tv"], lat: 47.4979, lon: 19.0402, country: "HU" },
    
    // --- ASIA & PACIFIC ---
    { keys: ["delhi", "mumbai", "india", "ndtv", "aaj tak", "zee news", "abp news", "republic bharat", "times now india", "zee rajasthan", "anada barta", "anshun comprehensive news channel", "star sports", "sony ten"], lat: 28.6139, lon: 77.2090, country: "IN" },
    ...
    { keys: ["seoul", "korea", "sbs world", "kbs world", "arirang", "mbn", "sbs sports", "chosun", "jtbc", "tvn korea"], lat: 37.5665, lon: 126.9780, country: "KR" },
    { keys: ["taipei", "taiwan", "pts", "set news", "f tv ", "tvbs", "cti"], lat: 25.0330, lon: 121.5654, country: "TW" },
    { keys: ["singapore", "channel newsasia", "cna", "mediacorp", "suria", "vasantham"], lat: 1.3521, lon: 103.8198, country: "SG" },
    { keys: ["hong kong", "hk", "tvb", "viu tv", "now tv"], lat: 22.3193, lon: 114.1694, country: "HK" },
    { keys: ["hanoi", "vietnam", "vtv", "ho chi minh", "cola tv", "htv"], lat: 21.0285, lon: 105.8542, country: "VN" },
    { keys: ["pyongyang", "north korea", "kctv", "dprk"], lat: 39.0392, lon: 125.7625, country: "KP" },
    { keys: ["sydney", "australia", "melbourne", "7news", "9news", "abc australia", "sbs", "sky racing", "sky racing 2", "fox footy", "kayo"], lat: -33.8688, lon: 151.2093, country: "AU" },
    { keys: ["new zealand", "auckland", "tvnz", "three nz", "skysport nz", "maori tv"], lat: -36.8485, lon: 174.7633, country: "NZ" },
    { keys: ["malaysia", "kuala lumpur", "astro", "tv3 malaysia", "rtm", "bernamatv"], lat: 3.1390, lon: 101.6869, country: "MY" },
    { keys: ["thailand", "bangkok", "thairath", "ch3 thailand", "ch7", "workpoint", "mono29", "truevisions"], lat: 13.7563, lon: 100.5018, country: "TH" },
    { keys: ["philippines", "manila", "gma", "abs-cbn", "tv5 philippines", "ptv"], lat: 14.5995, lon: 120.9842, country: "PH" },
    { keys: ["indonesia", "jakarta", "rcti", "sctv", "indosiar", "tvone", "trans7", "kompas tv"], lat: -6.2088, lon: 106.8456, country: "ID" },
    { keys: ["pakistan", "islamabad", "karachi", "geo news", "ary news", "ptv", "samaa", "dunyanews", "ten sports pk"], lat: 24.8607, lon: 67.0011, country: "PK" },
    { keys: ["bangladesh", "dhaka", "somoy", "ekattor", "jamuna", "channel i", "ntv bd", "btv", "tsports"], lat: 23.8103, lon: 90.4125, country: "BD" },

    // --- MIDDLE EAST & NORTH AFRICA (MENA) ---
    { keys: ["riyadh", "saudi", "al arabiya", "ksa sports", "al hadath", "munsif", "mecca", "medina", "makkah", "madinah", "ssc sports"], lat: 24.7136, lon: 46.6753, country: "SA" },
    { keys: ["cairo", "egypt", "nile tv", "dmc", "cbc egypt", "on e", "al ahly tv", "zamalek tv"], lat: 30.0444, lon: 31.2357, country: "EG" },
    { keys: ["lebanon", "beirut", "lbc", "al jadeed", "mtv lebanon", "tele liban", "red tv lebanon"], lat: 33.8938, lon: 35.5018, country: "LB" },
    { keys: ["afghanistan", "kabul", "afgh", "aria tv", "khurshid", "afghanistan international", "afghan tv", "tolo news"], lat: 34.5553, lon: 69.2075, country: "AF" },
    { keys: ["qatar", "doha", "al jazeera", "beinsports", "bein sports", "alkass"], lat: 25.2854, lon: 51.5310, country: "QA" },
    { keys: ["middle east", "dubai", "uae", "abu dhabi", "sharjah", "al yaum tv", "al ghad tv", "ad sports", "dubai sports"], lat: 25.2048, lon: 55.2708, country: "AE" },
    { keys: ["istanbul", "turkey", "trt", "haberturk", "atv turkey", "kanal d", "show tv", "beinsports tr"], lat: 41.0082, lon: 28.9784, country: "TR" },
    { keys: ["israel", "palestine", "jerusalem", "tel aviv", "ramallah", "gaza", "kan 11", "channel 12 israel", "i24news"], lat: 31.7683, lon: 35.2137, country: "IL" },
    { keys: ["iraq", "baghdad", "basra", "erbil", "al iraqiya", "rudaw", "kurdistan24"], lat: 33.3152, lon: 44.3661, country: "IQ" },
    { keys: ["iran", "tehran", "mashhad", "isfahan", "irib", "presstv"], lat: 35.6892, lon: 51.3890, country: "IR" },
    ...
    { keys: ["morocco", "rabat", "casablanca", "al aoula", "2m", "arryadia"], lat: 34.0209, lon: -6.8416, country: "MA" },
    { keys: ["algeria", "algiers", "entv", "echourouk", "ennahar"], lat: 36.7538, lon: 3.0588, country: "DZ" },

    // --- SUB-SAHARAN AFRICA ---
    { keys: ["south africa", "johannesburg", "cape town", "pretoria", "ln24sa", "sabc", "dstv", "supersport", "enca"], lat: -26.2041, lon: 28.0473, country: "ZA" },
    { keys: ["nigeria", "lagos", "abuja", "channels tv", "tvc news", "ait", "nta"], lat: 6.5244, lon: 3.3792, country: "NG" },
    { keys: ["ghana", "accra", "ghone", "adom tv", "utv ghana", "joy news", "gtv"], lat: 5.6037, lon: -0.1870, country: "GH" },
    { keys: ["kenya", "nairobi", "citizen tv", "ktn news", "ntv kenya", "kbc"], lat: -1.2921, lon: 36.8219, country: "KE" },
    { keys: ["africa", "pan africa", "african", "canal+ afrique", "trace africa"], lat: 9.0820, lon: 8.6753, country: "NG" }, // Generic African broadcast catch-all
